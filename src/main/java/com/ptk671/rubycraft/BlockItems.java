...
public class BlockItems {
    ...
    public static RegistryResult<Item> RUBY_STORAGE_MK_2_ITEM;
    public static void register() {
        ...
        RUBY_STORAGE_MK_2_ITEM = registry.registerItem(id("ruby_storage_mk_2"), () -> ItemUtil.ofBlock(Blocks.RUBY_STORAGE_MK_2.get(), new CompatibleItemSettings().addGroup(() -> RUBY_CRAFT_CREATIVE_TAB, id("ruby_storage_mk_2"))));
    }
}
