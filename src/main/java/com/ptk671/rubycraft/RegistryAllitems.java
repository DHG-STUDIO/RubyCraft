...
public class RegistryAllitems {
    public static void register() {
        ...
        Registry.register(Registry.ITEM, id( "ruby_block"), BlockItems.ruby_block_item);
        Registry.register(Registry.ITEM, id( "polished_ruby_block"), BlockItems.polished_ruby_block_item);
        Registry.register(Registry.ITEM, id( "ruby_ore"), BlockItems.ruby_ore_item);
        ...
        Registry.register(Registry.ITEM, id( "ruby_chest"), BlockItems.ruby_chest_item);
        Registry.register(Registry.ITEM, id( "ruby_gear"), Rubygear);
        Registry.register(Registry.ITEM, id( "machine_block"), BlockItems.machine_block_item);
        Registry.register(Registry.ITEM, id( "crushing_machine0"), BlockItems.crushing_machine_item);
    }
